 ...
 */
public class BusinessTask implements Taskable, Cloneable {
    ...
    /**
     * This constructor creates BusinessTask with id, taskName, description, date, priority.
     * @param taskName BusinessTask's name.
    ...
    /**
     * This constructor creates BusinessTask with id, taskName, description, date, contact, priority.
     * @param taskName BusinessTask's name.
     * @param description BusinessTask's description.
     * @param date BusinessTask's time notification.
     ...
     * @param priority BusinessTask's priority.
     */
    public BusinessTask(String taskName, String description, DateTime date, Contact contact, int priority){
        this.taskName = taskName;
        this.description = description;
        timeNotification = date;
     ...
     * @return id and taskName and timeNotification or 
     * id and taskName and description and timeNotification or
     * id and taskName and description and contact and timeNotification
     */
    @Override
     ...
     * @return true if objects are equal and both belongs BusinessTask,
