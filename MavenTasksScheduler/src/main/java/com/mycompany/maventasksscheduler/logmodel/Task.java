...
public abstract class Task {
    ...
    /**
     * Returns task's status: active, postponed, complete.
     *
    ...
    /**
     * This method edits contact with whom the task is connected. The
     * constructor - Contact(name) is called.
     *
    ...
    /**
     * This method edits contact with whom the task is connected. The
     * constructor - Contact(name, phoneNumber) is called.
     *
     * @param name Contact's name.
    ...
    /**
     * This method edits contact with whom the task is connected. The
     * constructor - Contact(name, phoneNumber, email) is called.
     *
     * @param name Contact's name.
     * @param phoneNumber Contact's phone number.
    ...
    /**
     * This method set task's status: 10 - active, 20 - postponed, 30 -
     * complete.
     *
