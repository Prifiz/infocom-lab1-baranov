...
import com.mycompany.maventasksscheduler.userinterface.gui.NotificationFrame;
 ...
 * @author Сергей
 */
public class MessageNotification implements Runnable, SystemNotification {
    ...
    public MessageNotification(LogImpl logModel) {
