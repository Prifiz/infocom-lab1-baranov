...
public class BirthdayTask extends Task implements Cloneable, java.io.Serializable {
    ...
    public String toString() {
        ...
        if (!(timeNotification.equals(new DateTime())
     ...
     * @return true if objects are equal and both belongs Birthday, false - in
     * all other cases.
     */
    @Override
    public boolean equals(Object o) {
        return o instanceof BirthdayTask
                && this.timeNotification.equals(
                ((BirthdayTask) o).timeNotification)
